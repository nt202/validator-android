...
import ru.nt202.jsonschema.validator.android.ReferenceSchema;
import ru.nt202.jsonschema.validator.android.Schema;
import ru.nt202.jsonschema.validator.android.loader.internal.ReferenceResolver;
...
class ReferenceLookup {
    ...
    static Map<String, Object> extend(Map<String, Object> additional, Map<String, Object> original) {
        ...
        Stream.of(original).forEach(entry -> rawObj.put(entry.getKey(), entry.getValue()));
        Stream.of(additional).forEach(entry -> rawObj.put(entry.getKey(), entry.getValue()));
        return rawObj;
    }
